...
export default function SettingsPage() {
  ...
  const [testing, setTesting] = useState<"storage" | "ai" | "embedding" | null>(null);
  ...
  const test = async (action: "test-storage" | "test-ai" | "test-embedding") => {
